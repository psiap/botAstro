...
async def start(message: types.Message, state: FSMContext):
    ...
    await message.answer('Карта дня - изображение, ассоциации с которой настроят вас на полезное состояние. Сконцентрируйтесь на карте и постарайтесь глубоко осмыслить то, что видите.')