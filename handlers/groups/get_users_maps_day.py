...
async def start(message: types.Message, state: FSMContext):
    ...
    captions = """<b>🎴Карта дня</b> - это изображение, которое отражает подсознательный настрой. Можно сосредоточиться на вопросе или ощущении и вытянуть карту.

Сконцентрируйтесь на изображении и постарайтесь глубоко осмыслить то, что видите. <b>Используйте метод ассоциаций</b>, чтобы получить подсказку подсознания 🧩
"""
