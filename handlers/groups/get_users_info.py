...
❗️Если задумаете переехать или улететь отдохнуть, в дальнейшем выберите кнопку ( 🚀Смена города) ❗️
 
Чтобы отправить геопозицию, нажмите на иконку "скрепка" в поле ввода сообщения и выберите опцию "Отправить геопозицию".""")
