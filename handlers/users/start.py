...
async def start(message: types.Message, state: FSMContext):
    ...
    msg = await bot.send_video(chat_id=message.from_user.id, video=open('data/video_2023-04-09_03-16-55 (online-video-cutter.com).mp4', 'rb'), caption="""<b>Здравствуйте 👋</b> Рад, что Вы решили использовать мои астрологические знания и опыт!

<b>🔹Я создан, чтобы сделать Вашу жизнь гармоничной и эффективной👌</b>
...
Давайте работать вместе, чтобы <b>не упускать возможности, поймать удачу 💰</b> и легче справляться с трудными моментами!
    """,
...
async def start(message: types.Message, state: FSMContext):
    ...
    msg = await bot.send_video(message.from_user.id, video=open('data/video_2023-04-09_03-16-55 (online-video-cutter.com).mp4', 'rb'),caption="""<b>Здравствуйте 👋</b> Рад, что Вы решили использовать мои астрологические знания и опыт!
